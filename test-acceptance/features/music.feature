...
Scenario: Erro ao adicionar um novo single
	...
	When Eu clico para adicionar um novo single
	And O sistema solicita  o "Nome do Single", "Artista/Banda", "Ano de Lançamento"
	And Eu preencho o campo "Nome do Single" com "I Saw You Close Your Eyes"
	When Eu clico em "Salvar" 
	Then Uma mensagem de "Informações Incompletas" é exibida na tela, e eu volto para a página para adicionar as informações
